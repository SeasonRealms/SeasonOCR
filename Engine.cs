...
public static partial class Engine
{
    ...
    /// <param name="imageData">Input image pixel buffer in RGB or RGBA byte layout.</param>
        ...
        string? dictionary = null)
    {
        ...
        if (boxes.Count == 0)
        {
            ...
            {
                seasonOcrResult.AnnotatedImage = BuildFallbackImage(imageData, width, height);
            }
        ...
        else
        {
            ...
            else
            {
                ...
                if (createAnnotatedImage)
                {
                    seasonOcrResult.AnnotatedImage = DrawResults(imageData, width, height, valid);
                }
